  ...
  return (
    <FadeInUp>
      <Link href={`/article/${article.id}`} className="block group">
        <div className="relative rounded-xl overflow-hidden bg-gray-900 border border-gray-800 h-80 transition-all duration-300 hover:border-teal-400/20 hover:glow-teal-sm hover:scale-[1.005]">
          <ArticleImage
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6">
            <div className="flex items-center gap-2 text-sm text-gray-400 mb-2 flex-wrap">
              ...
              <SectorTags article={article} max={3} />
            </div>
