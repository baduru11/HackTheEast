      ...
      {articles.map((article) => (
        <StaggerItem key={article.id}>
          <Link
            ...
            className="group bg-gray-900 border border-gray-800 rounded-lg overflow-hidden transition-all duration-300 hover:border-teal-400/20 hover:bg-gray-900/80 hover:scale-[1.02] hover:glow-teal-sm block h-full"
          >
